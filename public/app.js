  ...
  app.innerHTML = `
    ...
    <div class="page">
      ...
      <div class="card">
        ...
        <table class="ftable">
          <tr><td class="lbl">เลขที่เอกสาร</td><td class="auto" id="c_docno" data-docno="clean">กำลังออกเลข...</td></tr>
    ...
    <div class="page">
      ...
      <div class="card">
        <table class="ftable">
          ...
          <tr><td class="lbl">เลขที่เอกสาร</td><td class="auto" id="pr_docno" data-docno="press">กำลังออกเลข...</td></tr>
...
function pageInternalPrepare(app) {
  ...
  app.innerHTML = `
    ...
    <div class="page">
      ...
      <div class="card">
        <table class="ftable">
          <tr><td class="lbl">เลขที่เอกสาร</td><td class="auto" id="pp_docno" data-docno="prepare">กำลังออกเลข...</td></tr>
          <tr><td class="lbl">วันที่</td><td class="auto">${todayStr()}</td></tr>
          <tr><td class="lbl">เวลา</td><td class="auto">${nowTime()} น.</td></tr>
...
function pageExternalStretchSend(app) {
  ...
  app.innerHTML = `
    ...
    <div class="page">
      ...
      <div class="card">
        <table class="ftable">
          <tr><td class="lbl">เลขที่เอกสาร</td><td class="auto" id="sd_docno" data-docno="stretch_send">กำลังออกเลข...</td></tr>
          <tr><td class="lbl">วันที่</td><td class="auto">${todayStr()}</td></tr>
          <tr><td class="lbl">เวลา</td><td class="auto">${nowTime()} น.</td></tr>
