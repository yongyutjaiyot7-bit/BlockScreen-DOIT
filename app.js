...
async function pagePressDetail(app, {doc_no}) {
  ...
  app.innerHTML = `
    ...
    <div class="page">
      ...
      <div class="steps dt-steps">
        <div class="step ${stepN>=1?'done':''}">① ร้องขอ</div>
        <div class="step ${stepN>=2?(stepN===2?'active':'done'):''}">② รออัด</div>
        <div class="step ${stepN>=3?(stepN===3?'active':'done'):''}">③ ตรวจรับ</div>
        <div class="step ${stepN>=4?'active':''}">④ จัดเก็บ</div>
      </div>
